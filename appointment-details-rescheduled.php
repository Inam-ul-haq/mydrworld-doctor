...
<div class="position-relative mb-5">
    ...
    <div class="card-body">
        ...
        <div class="">
            ...
            <p>
                Doctor Unavailability on that date
            </p>
        </div>
        ...
        <div class="appointment-status-btns ">
            <!-- <button type="button" class="btn btn-primary waves-effect waves-light" data-bs-toggle="modal" disabled data-bs-target="#confirm-appointment">Confirm</button> -->
            ...
            <!-- <button type="button" class="btn btn-outline-primary waves-effect waves-light" data-bs-toggle="modal" disabled data-bs-target="#reschedule-modal">Reschedule</button> -->
