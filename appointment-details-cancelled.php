...
<div class="position-relative mb-5">
    ...
    <div class="card-body">
        ...
        <div class="appointment-status-btns">
            ...
            <button type="button" class="btn btn-dark waves-effect waves-light" data-bs-toggle="modal" data-bs-target="#cancel-appointment" disabled>Cancel</button>
            <button type="button" class="btn btn-outline-primary waves-effect waves-light" data-bs-toggle="modal" data-bs-target="#reschedule-modal" disabled>Reschedule</button>
            <button type="button" class="btn btn-secondary waves-effect waves-light" data-bs-toggle="modal" data-bs-target="#followup-modal" disabled>Follow Up</button>
            <button type="button" class="btn btn-success waves-effect waves-light" data-bs-toggle="modal" data-bs-target="#completed-appointment" disabled>Completed</button>
        </div> -->
</div>
