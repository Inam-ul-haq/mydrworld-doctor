...
<div class="authentication-bg min-vh-100">
                                    ...
                                    <form>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-12 mb-3">
                                                <div class="form-check py-1 d-flex align-items-center">
                                                    <input type="checkbox" class="form-check-input" id="auth-remember-check">
                                                    <label class="form-check-label" for="auth-remember-check"> by proceeding Agree <a href="#!" target="_blank">terms and conditions</a></label>
                                                </div>
                                            </div>
                                            <div class="col-12">
                                                <button class="btn btn-primary mx-auto waves-effect waves-light" type="button" data-bs-toggle="modal" data-bs-target=".otpmoal">Create An Account</button>
                                            </div>
    ...
    <!-- end authentication section -->
        ...
        <div class="modal fade otpmoal" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form>
                        <p class="text-center mb-4">To verify your mobile number, please enter the OTP that is sent to your mobile device ending in xxxxxxxxxxx63</p>
                        ...
                        <div class="mt-3">
                            <button class="btn btn-primary w-100 waves-effect waves-light" type="button">Submit</button>
                        </div>
                    </form>
                </div>
            </div>
